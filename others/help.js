...
module.exports = {
  name: `help`,
  description: `Megmutatja az öszes commandot.`,
  aliases: ["h","commands"],
  cooldown: 3,
  edesc: "Hogy egy commandrol szerezz infót, ${PREFIX}help <Command> ",
  execute(message,args,client) {
     
    let commands = message.client.commands.array();
 
    let helpEmbed = new MessageEmbed()
      .setTitle("HurkaTamasJoska2 Help")
      .setDescription(`**PREFIX:** \`${PREFIX}\` (ha megváltoztatad akkor az amire változtattad)`)
      ...
      switch(args[0]){
       ...
       if(ifargstruedothis>=0){
         ...
         if(aliases === undefined || !aliases) aliases="Nincs rövidítés!";
         let cooldown = commands[ifargstruedothis].cooldown;
         if(cooldown === undefined || !cooldown) cooldown="Nincs Cooldown!";
